...
--
-- Table structure for table `ref_hsbku`
--

DROP TABLE IF EXISTS `ref_hsbku`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ref_hsbku` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `kd_propinsi` int(10) DEFAULT NULL,
  `hsbku_pertanian` double NOT NULL DEFAULT 0,
  `hsbku_nonpertanian` double NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ref_hsbku`
--

LOCK TABLES `ref_hsbku` WRITE;
/*!40000 ALTER TABLE `ref_hsbku` DISABLE KEYS */;
INSERT INTO `ref_hsbku` VALUES (1,11,50000,100000),(2,12,50000,100000),(3,13,30000,100000),(4,14,60000,120000),(5,15,60000,100000),(6,16,50000,100000),(7,17,50000,60000),(8,18,40000,0),(9,19,50000,0),(10,21,50000,0),(11,31,50000,0),(12,32,50000,0),(13,33,60000,0),(14,34,40000,0),(15,35,50000,0),(16,36,40000,0),(17,51,50000,0),(18,52,0,0),(19,53,0,0),(20,61,0,0),(21,62,0,0),(22,63,0,0),(23,64,0,0),(24,65,0,0),(25,71,0,0),(26,72,0,0),(27,73,0,0),(28,74,0,0),(29,75,0,0),(30,76,0,0),(31,81,0,0),(32,82,0,0),(33,83,0,0),(34,92,0,0);
/*!40000 ALTER TABLE `ref_hsbku` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ref_jabatan_lapangan`
--

DROP TABLE IF EXISTS `ref_jabatan_lapangan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ref_jabatan_lapangan` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ref_jabatan_lapangan`
--

LOCK TABLES `ref_jabatan_lapangan` WRITE;
/*!40000 ALTER TABLE `ref_jabatan_lapangan` DISABLE KEYS */;
INSERT INTO `ref_jabatan_lapangan` VALUES (1,'Koordinator','2023-08-16 14:33:11'),(2,'Petugas Pengukuran dan Penggambaran','2023-08-16 14:33:26'),(3,'Petugas Pengukuran','2023-08-16 14:33:42');
/*!40000 ALTER TABLE `ref_jabatan_lapangan` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `t_expose`
--
...
CREATE TABLE `t_expose` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `no_undangan` varchar(25) DEFAULT NULL,
  `tujuan` int(10) DEFAULT NULL,
  `tgl_undangan` date DEFAULT NULL,
  `wkt_undangan` time DEFAULT NULL,
  `hari` varchar(15) DEFAULT NULL,
  `id_zoom` varchar(50) DEFAULT NULL,
  `pwd_zoom` varchar(50) DEFAULT NULL,
  `ttd` int(5) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `created_uid` int(5) DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `updated_uid` int(5) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `t_expose`
--

LOCK TABLES `t_expose` WRITE;
/*!40000 ALTER TABLE `t_expose` DISABLE KEYS */;
INSERT INTO `t_expose` VALUES (1,'001',7,'2023-08-23','10:32:15','Rabu','yt6589ui','12345678',2,'2023-08-20 22:32:52',1,'2023-08-21 00:32:17',1);
/*!40000 ALTER TABLE `t_expose` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_nodin`
--

DROP TABLE IF EXISTS `t_nodin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_nodin` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `nomor_nodin` varchar(25) DEFAULT NULL,
  `ttd_nodin` int(5) DEFAULT NULL,
  `jml_perusahaan` int(5) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `created_uid` int(5) DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
...
--
-- Dumping data for table `t_nodin`
--

LOCK TABLES `t_nodin` WRITE;
/*!40000 ALTER TABLE `t_nodin` DISABLE KEYS */;
INSERT INTO `t_nodin` VALUES (2,'001/nodin/08/2023',2,2,'2023-08-20 14:55:33',1,'2023-08-20 14:55:33',1);
/*!40000 ALTER TABLE `t_nodin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_nodin_company`
--

DROP TABLE IF EXISTS `t_nodin_company`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_nodin_company` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `id_nodin` int(10) DEFAULT NULL,
...
--
-- Dumping data for table `t_nodin_company`
--

LOCK TABLES `t_nodin_company` WRITE;
/*!40000 ALTER TABLE `t_nodin_company` DISABLE KEYS */;
INSERT INTO `t_nodin_company` VALUES (4,2,7,1),(5,2,8,1);
/*!40000 ALTER TABLE `t_nodin_company` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_pegawai_yg_ditugaskan`
--

DROP TABLE IF EXISTS `t_pegawai_yg_ditugaskan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_pegawai_yg_ditugaskan` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `id_sugaspar` int(10) DEFAULT NULL,
  `id_pegawai` int(10) DEFAULT NULL,
  `jabatan_lapangan` int(10) DEFAULT NULL,
  `sts` int(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `t_pegawai_yg_ditugaskan`
--

LOCK TABLES `t_pegawai_yg_ditugaskan` WRITE;
/*!40000 ALTER TABLE `t_pegawai_yg_ditugaskan` DISABLE KEYS */;
INSERT INTO `t_pegawai_yg_ditugaskan` VALUES (4,2,6,1,1),(5,2,21,3,1),(6,2,19,3,1),(7,2,5,2,1);
/*!40000 ALTER TABLE `t_pegawai_yg_ditugaskan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_permohonan_berkas` VALUES (54,6,1,1,1,'test.pdf','Valid','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(55,6,2,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(56,6,3,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(57,6,4,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(58,6,5,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(59,6,6,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(60,6,7,0,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(61,6,8,0,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(62,6,9,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(63,6,10,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(64,6,11,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(65,6,12,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(66,6,13,0,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(67,6,14,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(68,6,15,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(69,6,16,0,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(70,6,17,1,0,'','','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(71,6,18,1,NULL,NULL,'','2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(72,7,1,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(73,7,2,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(74,7,3,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(75,7,4,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(76,7,5,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(77,7,6,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(78,7,7,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(79,7,8,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(80,7,9,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(81,7,10,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(82,7,11,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(83,7,12,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(84,7,13,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(85,7,14,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(86,7,15,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(87,7,16,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(88,7,17,0,0,'','','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(89,7,18,0,NULL,'','Valid','2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(90,8,19,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(91,8,20,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(92,8,21,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(93,8,22,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(94,8,23,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(95,8,24,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(96,8,25,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(97,8,26,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(98,8,27,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(99,8,28,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(100,8,29,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(101,8,30,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(102,8,31,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(103,8,32,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(104,8,33,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(105,8,34,0,0,'','','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1),(106,8,35,1,NULL,NULL,'','2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1);
...
INSERT INTO `t_permohonan_pengukuran` VALUES (6,'120820235444',NULL,'PT Atlas Dinamika Persada',7.1287,NULL,14,1475,1,'pertanian',NULL,NULL,0,0,'2023-08-12 22:55:55',1,'2023-08-13 21:35:26',1),(7,'130820236735',NULL,'PT Wenx Technology',2.3629,'2023-08-14',33,3322,1,'pertanian',NULL,NULL,0,0,'2023-08-13 21:41:38',1,'2023-08-13 21:41:38',1),(8,'150820236335','Perpanjangan pengukuran','PT Geospace',922.7259,'2023-08-15',14,1401,2,'pertanian',NULL,NULL,0,0,'2023-08-15 23:19:35',1,'2023-08-15 23:35:48',1);
/*!40000 ALTER TABLE `t_permohonan_pengukuran` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_sbs`
--
...
CREATE TABLE `t_sbs` (
  ...
  `nomor_di_302` varchar(15) DEFAULT NULL,
  `nomor_di_305` varchar(15) DEFAULT NULL,
  `nomor_di_306` varchar(15) DEFAULT NULL,
  `tgl_sbs` date DEFAULT NULL,
  `created` datetime DEFAULT NULL,
...
--
-- Dumping data for table `t_sbs`
--

LOCK TABLES `t_sbs` WRITE;
/*!40000 ALTER TABLE `t_sbs` DISABLE KEYS */;
INSERT INTO `t_sbs` VALUES (2,'002','002_302','002_305','002_306','2023-08-21','2023-08-20 20:18:59',1,'2023-08-20 20:18:59',1);
/*!40000 ALTER TABLE `t_sbs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_sps`
--

DROP TABLE IF EXISTS `t_sps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_sps` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `no_pengantar` varchar(20) DEFAULT NULL,
  `tgl_pengantar` varchar(12) DEFAULT NULL,
  `id_perusahaan` int(5) DEFAULT NULL,
  `simponi` varchar(6) DEFAULT NULL,
  `tgl_simponi` varchar(10) DEFAULT NULL,
  `wkt_simponi` varchar(10) DEFAULT NULL,
  `pegawai_ttd` int(5) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `created_uid` int(5) DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `updated_uid` int(5) DEFAULT NULL,
...
--
-- Dumping data for table `t_sps`
--

LOCK TABLES `t_sps` WRITE;
/*!40000 ALTER TABLE `t_sps` DISABLE KEYS */;
INSERT INTO `t_sps` VALUES (3,'150820235309','15-08-2023',6,'358042','31-08-2023','23:35:45',9,'2023-08-15 00:36:09',1,'2023-08-15 00:36:09',1),(4,'150820232771','15-08-2023',8,'566529','18-08-2023','23:38:45',17,'2023-08-15 23:41:16',1,'2023-08-15 23:41:16',1);
/*!40000 ALTER TABLE `t_sps` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_sugaspar`
--

DROP TABLE IF EXISTS `t_sugaspar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_sugaspar` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `id_perusahaan` int(10) DEFAULT NULL,
  `no_surat` varchar(15) DEFAULT NULL,
  `tgl_surat` varchar(15) DEFAULT NULL,
  `ttdsurat` int(10) DEFAULT NULL,
  `no_pengantar` varchar(15) DEFAULT NULL,
  `tgl_pengantar` varchar(15) DEFAULT NULL,
  `tgl_berangkat` varchar(15) DEFAULT NULL,
  `thn_anggaran` varchar(4) DEFAULT NULL,
  `nomor_dipa` varchar(15) DEFAULT NULL,
  `tgl_dipa` varchar(10) DEFAULT NULL,
  `jml_petugaspusat` int(5) DEFAULT NULL,
  `jml_petugaskanwil` int(5) DEFAULT NULL,
  `jml_petugaskantah` int(5) DEFAULT NULL,
  `ibukota_prop` varchar(50) DEFAULT NULL,
  `ibukota_kab` varchar(50) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `created_uid` int(5) DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `updated_uid` int(5) DEFAULT NULL,
...
--
-- Dumping data for table `t_sugaspar`
--

LOCK TABLES `t_sugaspar` WRITE;
/*!40000 ALTER TABLE `t_sugaspar` DISABLE KEYS */;
INSERT INTO `t_sugaspar` VALUES (2,6,'02/2023','18-08-2023',7,'02/2023','18-08-2023','20-08-2023','2023','01/dipa/2023','18-08-2023',5,10,15,'Ciamis','bandung','2023-08-18 06:59:19',1,'2023-08-19 13:14:20',1);
/*!40000 ALTER TABLE `t_sugaspar` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `v_expose`
--

DROP TABLE IF EXISTS `v_expose`;
/*!50001 DROP VIEW IF EXISTS `v_expose`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_expose` (
  `id` tinyint NOT NULL,
  `no_undangan` tinyint NOT NULL,
  `tgl_undangan` tinyint NOT NULL,
  `wkt_undangan` tinyint NOT NULL,
  `id_zoom` tinyint NOT NULL,
  `pwd_zoom` tinyint NOT NULL,
  `nm_perusahaan` tinyint NOT NULL,
  `nama_ttd` tinyint NOT NULL,
  `nip` tinyint NOT NULL,
  `propinsi` tinyint NOT NULL,
  `dati2` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_nodin`
--

DROP TABLE IF EXISTS `v_nodin`;
/*!50001 DROP VIEW IF EXISTS `v_nodin`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_nodin` (
  `id` tinyint NOT NULL,
  `nomor_nodin` tinyint NOT NULL,
  `nama` tinyint NOT NULL,
  `nip` tinyint NOT NULL,
  `jml_perusahaan` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_nodin_company`
--

DROP TABLE IF EXISTS `v_nodin_company`;
/*!50001 DROP VIEW IF EXISTS `v_nodin_company`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_nodin_company` (
  `id` tinyint NOT NULL,
  `id_nodin` tinyint NOT NULL,
  `id_perusahaan` tinyint NOT NULL,
  `nm_perusahaan` tinyint NOT NULL,
  `luas_permohonan` tinyint NOT NULL,
  `kategori_lahan` tinyint NOT NULL,
  `propinsi` tinyint NOT NULL,
  `hsbku` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `v_petugas_lapangan`
--

DROP TABLE IF EXISTS `v_petugas_lapangan`;
/*!50001 DROP VIEW IF EXISTS `v_petugas_lapangan`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_petugas_lapangan` (
  `id` tinyint NOT NULL,
  `id_sugaspar` tinyint NOT NULL,
  `nama` tinyint NOT NULL,
...
--
-- Temporary table structure for view `v_sps`
--

DROP TABLE IF EXISTS `v_sps`;
/*!50001 DROP VIEW IF EXISTS `v_sps`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_sps` (
  `id` tinyint NOT NULL,
  `no_pengantar` tinyint NOT NULL,
  `tgl_pengantar` tinyint NOT NULL,
  `simponi` tinyint NOT NULL,
  `tgl_simponi` tinyint NOT NULL,
  `wkt_simponi` tinyint NOT NULL,
  `nm_perusahaan` tinyint NOT NULL,
  `no_permohonan` tinyint NOT NULL,
  `tgl_permohonan` tinyint NOT NULL,
  `luas_permohonan` tinyint NOT NULL,
  `dati2` tinyint NOT NULL,
  `propinsi` tinyint NOT NULL,
  `perihal_permohonan` tinyint NOT NULL,
  `kategori_lahan` tinyint NOT NULL,
  `nama_ttd` tinyint NOT NULL,
  `nip` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Temporary table structure for view `v_sugaspar`
--

DROP TABLE IF EXISTS `v_sugaspar`;
/*!50001 DROP VIEW IF EXISTS `v_sugaspar`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_sugaspar` (
  `id` tinyint NOT NULL,
  `no_surat` tinyint NOT NULL,
  `tgl_surat` tinyint NOT NULL,
  `nm_perusahaan` tinyint NOT NULL,
  `no_pengantar` tinyint NOT NULL,
  `tgl_pengantar` tinyint NOT NULL,
  `tgl_berangkat` tinyint NOT NULL,
  `nama_ttd` tinyint NOT NULL,
  `nip_ttd` tinyint NOT NULL,
  `luas_permohonan` tinyint NOT NULL,
  `dati2` tinyint NOT NULL,
  `propinsi` tinyint NOT NULL,
  `ibukota_prop` tinyint NOT NULL,
  `ibukota_kab` tinyint NOT NULL,
  `thn_anggaran` tinyint NOT NULL,
  `nomor_dipa` tinyint NOT NULL,
  `tgl_dipa` tinyint NOT NULL,
  `jml_petugaspusat` tinyint NOT NULL,
  `jml_petugaskanwil` tinyint NOT NULL,
  `jml_petugaskantah` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `v_expose`
--

/*!50001 DROP TABLE IF EXISTS `v_expose`*/;
/*!50001 DROP VIEW IF EXISTS `v_expose`*/;
...
/*!50001 VIEW `v_expose` AS select `a`.`id` AS `id`,`a`.`no_undangan` AS `no_undangan`,concat(`a`.`hari`,', ',date_format(`a`.`tgl_undangan`,'%d-%m-%Y')) AS `tgl_undangan`,`a`.`wkt_undangan` AS `wkt_undangan`,`a`.`id_zoom` AS `id_zoom`,`a`.`pwd_zoom` AS `pwd_zoom`,`b`.`nm_perusahaan` AS `nm_perusahaan`,`c`.`nama` AS `nama_ttd`,`c`.`nip` AS `nip`,`d`.`NM_PROVINSI` AS `propinsi`,`dt`.`NM_DATI2` AS `dati2` from ((((`t_expose` `a` left join `t_permohonan_pengukuran` `b` on(`b`.`id` = `a`.`tujuan`)) left join `dat_pegawai` `c` on(`c`.`id` = `a`.`ttd`)) left join `ref_provinsi` `d` on(`d`.`KD_PROVINSI` = `b`.`propinsi` and `b`.`id` = `a`.`tujuan`)) left join `ref_dati2` `dt` on(`dt`.`KD_PROVINSI` = `b`.`propinsi` and `dt`.`KD_DATI2` = `b`.`dati2` and `b`.`id` = `a`.`tujuan`)) order by `a`.`created` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_nodin`
--

/*!50001 DROP TABLE IF EXISTS `v_nodin`*/;
/*!50001 DROP VIEW IF EXISTS `v_nodin`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_nodin` AS select `a`.`id` AS `id`,`a`.`nomor_nodin` AS `nomor_nodin`,`b`.`nama` AS `nama`,`b`.`nip` AS `nip`,`a`.`jml_perusahaan` AS `jml_perusahaan` from (`t_nodin` `a` left join `dat_pegawai` `b` on(`b`.`id` = `a`.`ttd_nodin`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_nodin_company`
--

/*!50001 DROP TABLE IF EXISTS `v_nodin_company`*/;
/*!50001 DROP VIEW IF EXISTS `v_nodin_company`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_nodin_company` AS select `a`.`id` AS `id`,`a`.`id_nodin` AS `id_nodin`,`a`.`id_perusahaan` AS `id_perusahaan`,`b`.`nm_perusahaan` AS `nm_perusahaan`,`b`.`luas_permohonan` AS `luas_permohonan`,`b`.`kategori_lahan` AS `kategori_lahan`,`b`.`propinsi` AS `propinsi`,if(`b`.`kategori_lahan` = 'pertanian',`c`.`hsbku_pertanian`,`c`.`hsbku_nonpertanian`) AS `hsbku` from ((`t_nodin_company` `a` left join `t_permohonan_pengukuran` `b` on(`b`.`id` = `a`.`id_perusahaan`)) left join `ref_hsbku` `c` on(`c`.`kd_propinsi` = `b`.`propinsi` and `b`.`id` = `a`.`id_perusahaan`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `v_petugas_lapangan`
--

/*!50001 DROP TABLE IF EXISTS `v_petugas_lapangan`*/;
/*!50001 DROP VIEW IF EXISTS `v_petugas_lapangan`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_petugas_lapangan` AS select `a`.`id` AS `id`,`a`.`id_sugaspar` AS `id_sugaspar`,`b`.`nama` AS `nama`,`b`.`golongan` AS `golongan`,`c`.`nama_jabatan` AS `nama_jabatan` from ((`t_pegawai_yg_ditugaskan` `a` left join `dat_pegawai` `b` on(`b`.`id` = `a`.`id_pegawai`)) left join `ref_jabatan_lapangan` `c` on(`c`.`id` = `a`.`jabatan_lapangan`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_sps`
--

/*!50001 DROP TABLE IF EXISTS `v_sps`*/;
/*!50001 DROP VIEW IF EXISTS `v_sps`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_sps` AS select `a`.`id` AS `id`,`a`.`no_pengantar` AS `no_pengantar`,`a`.`tgl_pengantar` AS `tgl_pengantar`,`a`.`simponi` AS `simponi`,`a`.`tgl_simponi` AS `tgl_simponi`,`a`.`wkt_simponi` AS `wkt_simponi`,`b`.`nm_perusahaan` AS `nm_perusahaan`,`b`.`no_permohonan` AS `no_permohonan`,`b`.`tgl_permohonan` AS `tgl_permohonan`,`b`.`luas_permohonan` AS `luas_permohonan`,`b`.`dati2` AS `dati2`,`b`.`propinsi` AS `propinsi`,`b`.`perihal_permohonan` AS `perihal_permohonan`,`b`.`kategori_lahan` AS `kategori_lahan`,`c`.`nama` AS `nama_ttd`,`c`.`nip` AS `nip` from ((`t_sps` `a` left join `t_permohonan_pengukuran` `b` on(`b`.`id` = `a`.`id_perusahaan`)) left join `dat_pegawai` `c` on(`c`.`id` = `a`.`pegawai_ttd`)) order by `a`.`created_date` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_sugaspar`
--

/*!50001 DROP TABLE IF EXISTS `v_sugaspar`*/;
/*!50001 DROP VIEW IF EXISTS `v_sugaspar`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_sugaspar` AS select `a`.`id` AS `id`,`a`.`no_surat` AS `no_surat`,`a`.`tgl_surat` AS `tgl_surat`,`b`.`nm_perusahaan` AS `nm_perusahaan`,`a`.`no_pengantar` AS `no_pengantar`,`a`.`tgl_pengantar` AS `tgl_pengantar`,`a`.`tgl_berangkat` AS `tgl_berangkat`,`c`.`nama` AS `nama_ttd`,`c`.`nip` AS `nip_ttd`,`b`.`luas_permohonan` AS `luas_permohonan`,`b`.`dati2` AS `dati2`,`b`.`propinsi` AS `propinsi`,`a`.`ibukota_prop` AS `ibukota_prop`,`a`.`ibukota_kab` AS `ibukota_kab`,`a`.`thn_anggaran` AS `thn_anggaran`,`a`.`nomor_dipa` AS `nomor_dipa`,`a`.`tgl_dipa` AS `tgl_dipa`,`a`.`jml_petugaspusat` AS `jml_petugaspusat`,`a`.`jml_petugaskanwil` AS `jml_petugaskanwil`,`a`.`jml_petugaskantah` AS `jml_petugaskantah` from ((`t_sugaspar` `a` left join `t_permohonan_pengukuran` `b` on(`b`.`id` = `a`.`id_perusahaan`)) left join `dat_pegawai` `c` on(`c`.`id` = `a`.`ttdsurat`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-08-21  0:47:09
